...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        const searchInput = document.getElementById('zavod_search');
        
        if (searchInput && typeof TomSelect !== 'undefined') {
            ...
            console.warn("TomSelect se nepodařilo inicializovat – chybí knihovna nebo prvek v HTML.");
        }
        ...
        if (filterCheckbox) {
            ...
            console.error("Tlačítko s ID 'btnCheckMoje' nebylo v HTML nalezeno!");
        }
    });
</script>
<?= $this->endSection() ?>